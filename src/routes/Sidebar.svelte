<script lang="ts">
    import { useDnD } from './DnDService.svelte';
   ...
   <aside>
    <div class="label">You can drag the relevant nodes to the pane below.</div>
    <div class="nodes-container">
      <div class="input-node node"
      on:dragstart={(event) => onDragStart(event, 'input')} 
      draggable={true} role="application">
        Input Node
      </div>
      <div
